...
노래 관리 - 정답 관리 - 게임 관리 - 챌린지 관리 - 영향받은 곡 - 멀티게임 관리 - 회원 관리 - 대중성 투표 - 통계 분석 - 배치 관리 - 메뉴 관리 - 비속어 필터 - 장르 관리

다음과 같이 요청해주세요:                                                                                      
┌───────────────────────┬─────────────────────────────────────────────────────────────────────┐                
│       요청 방식       │                                예시                                 │                
├───────────────────────┼─────────────────────────────────────────────────────────────────────┤                
│ 부모-자식 대비 명시   │ "버튼이 어떤 배경 위에 놓이는지 확인하고, 대비가 충분한지 검증해줘" │                
├───────────────────────┼─────────────────────────────────────────────────────────────────────┤                
│ 실제 색상값 계산 요청 │ "CSS 변수 말고 실제로 렌더링되는 hex 색상값으로 비교해줘"           │                
├───────────────────────┼─────────────────────────────────────────────────────────────────────┤                
│ 컨텍스트 분석 요청    │ "해당 요소의 부모 컨테이너 배경색과 함께 분석해줘"                  │                
├───────────────────────┼─────────────────────────────────────────────────────────────────────┤                
│ 시각적 구분 기준 제시 │ "배경 대비 최소 명도 차이 10% 이상인지 확인해줘"                    │                
└───────────────────────┴─────────────────────────────────────────────────────────────────────┘

http://localhost:8082/ 접근해서 비 로그인으로 접근 가능한 모든 메뉴 확인
http://localhost:8082/ 접근해서 rbgud2380@naver.com / 1234 로그인 후 로그인으로 접근 가능한 모든 메뉴 확인

1. 부모 컨테이너의 배경색과 대비 분석
2. 라이트/다크 모드 각각 실제 hex 값으로 비교
3. 텍스트-배경, 요소-컨테이너 대비가 충분한지 판단      