...
function initializeScripts() {
    ...
    // 탭별 초기화 함수 호출
    if (currentTab === 'history' && typeof initHistoryTab === 'function') {
        initHistoryTab();
    } else if (currentTab === 'multi' && typeof initMultiTab === 'function') {
        initMultiTab();
    } else if (currentTab === 'challenge' && typeof initChallengeTab === 'function') {
        initChallengeTab();
    }
}
